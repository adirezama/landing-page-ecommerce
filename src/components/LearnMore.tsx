...
export function LearnMore() {
  return (
    <section className=" my-20 p-4 sm:p-2 md:p-0">
      <div className="max-w-6xl mx-auto grid gap-4 grid-flow-row-dense grid-cols-2 md:grid-cols-3">
        <div className="col-span-2 bg-red-400 overflow-hidden rounded-tl-xl rounded-bl-xl">
          <div className="flex h-[31.25rem]">
            ...
            <div className="flex flex-col justify-center items-center w-[40%] bg-black text-white">
              <a
                href="#"
                className="bg-white text-black text-center p-2 w-32 rounded-full mb-4 transition5s">
                Our Story
              </a>
        ...
        <div className="flex flex-col md:justify-center items-center rounded-tr-xl rounded-br-xl h-60 md:h-[31.25rem] col-span-2 md:col-span-1 md:bg-gray-200 md:bg-opacity-50">
          ...
          <a
            href="#"
            className="bg-black text-white p-2 w-32 rounded-full text-center transition5s">
            Our Story
          </a>
        </div>
        <div className="col-span-2 bg-red-400 overflow-hidden rounded-tl-xl rounded-bl-xl">
